...
import { LoginState, LoginType } from "@/src/slices/login/login-state";
import { loginActions } from "@/src/slices/login/login-slice";
...
export function LoginNewPassword({
    className,
    ...props
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="space-y-2">
                                            ...
                                            <Input
                                                ...
                                                onChange={(e) => {
                                                    dispatch(loginActions.setNewPassword(e.target.value));
                                                }}
                                            />
                                            <FormMessage />
                                        </FormItem>
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="space-y-2">
                                            ...
                                            <Input
                                                ...
                                                onChange={(e) => {
                                                    dispatch(loginActions.setNewPasswordConfirm(e.target.value));
                                                }}
                                            />
                                            <FormMessage />
                                        </FormItem>
