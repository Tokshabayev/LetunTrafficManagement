...
import { flightsActions, uploadFlightsAsync } from "@/src/slices/flights/flights-slice";
import { CreateMyFlightButton } from "./create-my-flight-button";
...
export function MyFlightsTable() {
