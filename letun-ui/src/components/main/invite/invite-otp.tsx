...
import {
    inviteActions,
    submitInviteOtpAsync,
    submitInvitePhoneAsync,
} from "@/src/slices/invite/invite-slice";
import { InviteState } from "@/src/slices/invite/invite-state";
                                ...
                                <FormItem className="space-y-2">
                                    ...
                                    <FormControl>
                                        <InputOTP
                                            ...
                                            {...field}
                                            onChange={(e) => {
                                                dispatch(inviteActions.setOtp(e));
                                            }}
                                            onSubmit={(e) => {
                                                e.preventDefault();
                                                dispatch(submitInviteOtpAsync());
                                            }}
                                        >
                                            <InputOTPGroup>
                                                {[...Array(6)].map((_, i) => (
